...
import hotel.regras.cadastro.RegraCadastroFuncionario;
...
public class TelaCadastroFuncionario extends Tela {
	...
	private RegraCadastroFuncionario regraFuncionario;
	...
	public TelaCadastroFuncionario(TelaPrincipal telaPrincipal) {
		...
		regraFuncionario = new RegraCadastroFuncionario(this);
		
		UtilCombobox.inicializarComboBoxPais(comboBoxPais);	
		UtilCombobox.inicializarComboBoxCargo(comboBoxCargo);
	...
	private void inicializarLayoutEEventos() {
		...
		comboBoxCargo.setBounds(120, 103, 181, 20);
		getContentPane().add(comboBoxCargo);
		
		JLabel labelCargo = new JLabel("Cargo");
		labelCargo.setBounds(59, 106, 46, 14);
		...
		lblNome.setBounds(59, 139, 46, 14);
		getContentPane().add(lblNome);

		textFieldNome = new JTextField();
		textFieldNome.setBounds(120, 138, 181, 20);
		getContentPane().add(textFieldNome);
		textFieldNome.setColumns(10);

		JLabel lblCpf = new JLabel("CPF");
		lblCpf.setBounds(59, 167, 46, 14);
		getContentPane().add(lblCpf);

		textFieldCpf = new JTextField();
		textFieldCpf.setBounds(120, 164, 181, 20);
		getContentPane().add(textFieldCpf);
		textFieldCpf.setColumns(10);

		JLabel lblTelefone = new JLabel("Telefone");
		lblTelefone.setBounds(59, 197, 46, 14);
		getContentPane().add(lblTelefone);

		textFieldTelefone = new JTextField();
		textFieldTelefone.setBounds(120, 194, 181, 20);
		getContentPane().add(textFieldTelefone);
		textFieldTelefone.setColumns(10);

		JLabel lblEndereo = new JLabel("Endereço");
		lblEndereo.setBounds(59, 370, 46, 14);
		getContentPane().add(lblEndereo);

		textFieldEndereco = new JTextField();
		textFieldEndereco.setBounds(120, 367, 181, 20);
		getContentPane().add(textFieldEndereco);
		textFieldEndereco.setColumns(10);

		JLabel lblEmail = new JLabel("E-mail");
		lblEmail.setBounds(59, 225, 46, 14);
		getContentPane().add(lblEmail);

		textFieldEmail = new JTextField();
		textFieldEmail.setBounds(120, 222, 181, 20);
		getContentPane().add(textFieldEmail);
		textFieldEmail.setColumns(10);

		JLabel lblNewLabel = new JLabel("País");
		lblNewLabel.setBounds(59, 262, 46, 14);
		...
		comboBoxPais.setBounds(120, 259, 181, 20);
		getContentPane().add(comboBoxPais);

		JLabel lblEstafo = new JLabel("Estado");
		lblEstafo.setBounds(59, 299, 46, 14);
		...
		comboBoxEstado.setBounds(120, 296, 181, 20);
		getContentPane().add(comboBoxEstado);

		JLabel lblCidade = new JLabel("Cidade");
		lblCidade.setBounds(59, 338, 46, 14);
		getContentPane().add(lblCidade);

		comboBoxCidade = new JComboBox<Object>();
		comboBoxCidade.setBounds(120, 335, 181, 20);
	...
	protected void incluir() {
		if (isFormularioValido()) {
			...
			if (JOptionPane.OK_OPTION == result) {
				regraFuncionario.incluirFuncionario();
				limpaCampos();
				inicializarComboBoxCodigo();
			}
		} else {
	...
	protected void excluir() {
		regraFuncionario.excluirFuncionario();
		limpaCampos();
		inicializarComboBoxCodigo();
	}
	...
	protected void mostrar() {
		regraFuncionario.mostrarFuncionario();
	...
	protected void alterar() {
		if (isFormularioValido()) {
			int result = JOptionPane.showConfirmDialog(null, "Confirmar a alteração?", "Confirmar",
					JOptionPane.OK_CANCEL_OPTION);
			if (JOptionPane.OK_OPTION == result) {
				regraFuncionario.alterarFuncionario();
				limpaCampos();
				inicializarComboBoxCodigo();
	...
	protected void consultar() {
		TelaConsultaGeral telaConsulta = new TelaConsultaGeral(ETipos.Funcionario, this);
	...
	public void inicializarComboBoxCodigo() {
		try {
			...
			List<Funcionario> funcionarios = cl.getLista();
			comboBoxCodigo.setModel(new DefaultComboBoxModel<Object>(funcionarios.toArray()));
	...
	public Cargo getCargoSelecionado() {
		return ((Cargo) comboBoxCargo.getSelectedItem());
	}
	...
	public Funcionario getFuncionarioSelecionado() {
		return ((Funcionario) comboBoxCodigo.getSelectedItem());
	}
	...
	public void setSelectedComboBoxCargo(Cargo cargo) {
		this.comboBoxCargo.getModel().setSelectedItem(cargo);
	}
	...
	public void setSelectedComboBoxCodigo(Funcionario funcionario) {
		this.comboBoxCodigo.getModel().setSelectedItem(funcionario);
	}
